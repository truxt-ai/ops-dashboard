...
const { getActivePromoCodes } = require('./lib/promo-codes');
...
// List the promo codes a customer may currently use. Retired codes are
// filtered out by the shared helper, so the billing page never offers them.
